...
public class Funciones_read {
	...
	public static void read_admin(){
		...
		Persona p1;
		String [] menu2={Languages.lenguajes.getProperty("read")+" "+Languages.lenguajes.getProperty("client"),
				Languages.lenguajes.getProperty("read")+" "+Languages.lenguajes.getProperty("admin"),Languages.lenguajes.getProperty("exit")};
		int menus = funciones.menu(menu2, Languages.lenguajes.getProperty("crear"), Languages.lenguajes.getProperty("opciones"));
		switch(menus){
		case 0:
			Funciones_read.read_client2();
			break;
		case 1:
