...
public class Main_Framework2 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			String[] login = funciones.Menu_login();
			boolean good = false;
			menprin = funciones.menu(principal, Languages.lenguajes.getProperty("menu"),
					Languages.lenguajes.getProperty("menu"));
			switch (menprin) {
			case 0:
				do {
					Open.Open_auto();
					...
					case 0:
						...
						do {
							menlog = funciones.menu(login, Languages.lenguajes.getProperty("crear"),
									Languages.lenguajes.getProperty("opciones"));
							switch (menlog) {
							case 0:
