...
public int comparaFechas1(Clase_Fecha Fecha_naix){
	
	Calendar cal1 = this.StringToCalendar2(this.toString());
	Calendar cal2 = this.StringToCalendar2(Fecha_naix.toString());
